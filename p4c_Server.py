...
def p4c(self, idServer, idClient, isServer):
    ...
    while joue:
        ...
        if data[0] == "server":
            if data[1] != "0":
                mat = placer_pion(nom2[1], int(data[1])-1, matrice)
                matrice = mat[1]
                data[1] = "0"
            ...
            if teste_fin_jeu(gagnant(matrice), nom1, nom2, data, matrice):
                ...
                mat = placer_pion(nom2[1], int(data[2])-1, matrice)
                matrice = mat[1]
